...
public class frmAnSanPham extends javax.swing.JFrame {
    ...
    private void btnAnSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAnSanPhamActionPerformed
      String MaSanPham,  TrangThai ;
        MaSanPham = lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.GetMaSanPham();       
        TrangThai = "0";
    ...
    private void btnXoaSanPhamActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaSanPhamActionPerformed
             ...
             if(! lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.GetMaSanPham().equals("")){
        lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.XoaSanPham();
       lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.ResSanPham();
}
else
     lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.ThongBao("bạn chưa nhập mã sản phẩm", "lỗi khi xóa",2);
