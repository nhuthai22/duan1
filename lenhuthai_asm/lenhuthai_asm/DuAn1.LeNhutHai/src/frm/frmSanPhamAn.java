...
public class frmSanPhamAn extends javax.swing.JFrame {
    ...
    private void tblSanPham_spaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblSanPham_spaMouseClicked
        ...
        lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.setSelectedCombobox(tblSanPham_spa.getValueAt(viTriDongVuaBam, 3).toString(), cbbMaLoaiSanPham_SanPhamAn);
        lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.setSelectedCombobox(tblSanPham_spa.getValueAt(viTriDongVuaBam, 6).toString(), cbbHangSanXuat_SanPhamAn);
    ...
    private void jPanelSanPham_spaComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_jPanelSanPham_spaComponentShown
       LayDuLieuSanPham("0");
        ...
        cbbMaLoaiSanPham_SanPhamAn.setModel(lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.LayDuLieucbb("LoaiSanPham", "TenLoaiSanPham", "MaLoaiSanPham"));
        cbbHangSanXuat_SanPhamAn.setModel(lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.LayDuLieucbb("HangSanXuat", "TenHangSanXuat", "MaHangSanXuat"));
    ...
    private void btnHienlai_SanPhamAnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHienlai_SanPhamAnActionPerformed
        ...
        if (kiemtra) {
            ...
            lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.ThongBao("Không thể ", "Sửa Sản Phẩm", 2);
        }
      LayDuLieuSanPham("0");
      ResSanPham();
      lenhuthai_asm_gd2.LENHUTHAI_ASM_GD2.frmTC.LayDuLieuSanPham("1");
